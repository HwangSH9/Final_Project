...
import org.zerock.domain.MissingVO;
import org.zerock.domain.PageDTO;
import org.zerock.service.MissingService;
...
public class MissingController {
	...
	*/
	...
	public void list(Criteria cri, Model model) {
		...
		// 그리고, http://localhost:9005/missing/list 웹사이트에서
	...
	// 때문에 편리합니다.
	// BoardController에서 register() 메서드는 "redirect:/missing/list"를
	// 전송하는데 브라우저는 이를 통보받은 후 "/missing/list"로 이동하게 됩니다.
	...
	public String register(MissingVO board, RedirectAttributes rttr) {
...
//		log.info("/get 조회  처리");
	...
	@PostMapping("/modify")
	public String modify(MissingVO board, @ModelAttribute("cri") Criteria cri, RedirectAttributes rttr) {
	...
	public String remove(@RequestParam("bno") Long bno, Criteria cri, RedirectAttributes rttr, String writer) {
		...
		// Page581 아래 1줄 소스 코딩 추가
		return "redirect:/missing/list" + cri.getListLink();
	}
