...
<!-- 
<button data-oper='modify' class="btn btn-default" onclick="location.href='/missing/modify?bno=<c:out value="${board.bno}" /> '">Modify 수정!</button>
 -->        
...
<button data-oper='list' class="btn btn-info" onclick="location.href='/missing/list'">List 보여주세요!</button>
...
<script type="text/javascript">
	...
	*/
	...
	// 웹프로젝트 구동 후 http://localhost:9005/missing/list 웹 주소 입력 
